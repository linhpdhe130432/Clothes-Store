    ...
    <body>
        ...
        <div class="content">
            <div class="logo container d-flex align-items-center text-white" style="height: 215px;">
                <span style="font-size: 40px;text-decoration: line-through">FINAL SALE</span>
            </div>
            <div class="product">
                <div class="container">
                    <div class="row">
                                ...
                                <th class="w-75">
                                    ...
                                    <div class="item">
                                        <div class="row">
                                            ...
                                            <%}%>
                                            <div class="d-flex justify-content-center w-100"><%=HtmlHelper.pagerSale(pageindex, pagecount, 1)%></div>
                                        </div>
                                    </div>
                                </th>
                            </tr>
