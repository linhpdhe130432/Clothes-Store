<%-- 
    Document   : women
    Created on : Dec 18, 2019, 10:54:36 PM
    Author     : USER
--%>
...
<html>
    <head>
        ...
        <%
            ArrayList<Product> womens
                    = (ArrayList<Product>) request.getAttribute("womens");
    ...
    <body>
        ...
        <div class="content">
            <div class="logo container d-flex align-items-center text-white" style="height: 215px;">
                <span style="font-size: 40px;text-decoration: line-through">FEMALE'S SNEAKERS</span>
            </div>
            <div class="product">
                <div class="container">
                    <div class="row">
                                ...
                                <th class="w-75">
                                    ...
                                    <div class="item">
                                        <div class="row">
                                            ...
                                            <%}%>
                                            <div class="d-flex justify-content-center w-100"><%=HtmlHelper.pagerWomen(pageindex, pagecount, 1)%></div>
                                        </div>
                                    </div>
                                </th>
                            </tr>
